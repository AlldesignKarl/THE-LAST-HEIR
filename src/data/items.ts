...
export const ITEMS: Record<string, ItemDef> = Object.fromEntries([
  ...
  I({ id: 'plank', name: 'Tablón', desc: 'Madera aserrada. Se obtiene partiendo troncos con el hacha.', category: 'resource', weight: 1.5, value: 3, stack: 30, model: 'plank' }),
  I({ id: 'thatch', name: 'Haz de paja', desc: 'Para techar. Se compra o se siega en los campos.', category: 'resource', weight: 1, value: 2, stack: 30, model: 'thatch_bundle' }),
  ...
  I({ id: 'stone', name: 'Piedra', desc: 'Una piedra del tamaño de un puño.', category: 'resource', weight: 1.5, value: 0, stack: 10, model: 'stone' }),
