...
export const ITEMS: Record<string, ItemDef> = Object.fromEntries([
  ...
  I({ id: 'club', name: 'Maza de bandido', desc: 'Madera dura con clavos de hierro.', category: 'weapon', weight: 2.0, value: 20, stack: 1, model: 'axe', weapon: 'club' }),
  I({ id: 'spear', name: 'Lanza', desc: 'Asta de fresno con punta de hierro. Mantiene la distancia.', category: 'weapon', weight: 2.2, value: 55, stack: 1, model: 'sword', weapon: 'spear' }),
